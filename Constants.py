genres = {'Adventure': 1, 'Family': 2, 'Fantasy': 3, 'Musical': 4, 'Action': 5,
          'Sci-Fi': 6, 'Drama': 7, 'War': 8, 'Horror': 9, 'Mystery': 10, 'Thriller': 11,
          'Romance': 12, 'Crime': 13, 'Western': 14, 'History': 15, 'Film-Noir': 16,
          'Documentary': 17, 'Animation': 18, 'Comedy': 19, 'Short': 20, 'Sport': 21, 'Music': 22, 'Talk-Show': 23,
          'Biography': 24, 'Game-Show': 25, 'News': 26, 'Adult': 27, 'Reality-TV': 28}

movie_master_get_insert_identity_header = """insert into movies_master(name,description,date_of_release,score,
              director,popularity) values"""

movie_genre_get_header = """insert into movie_genre(movie_id, genre_id)values"""

actor_type_get_header = """insert into movie_actors(movie_id, actor_type_id, actor_name)values"""

actor_type = """insert into actor_master(id, actor_type)values"""

genre_type = """insert into genre_master(genre_id, name)values"""
